...
module.exports = {
  ...
  slides: [
    ...
    // ============== 比較系 ==============
    {
      kind: "cards",
      section: "compare",
      title: "kind: cards ─ 2 枚配置: 2 主体の対比（中立）",
      message:
        "cards を 2 件にすると左右対比レイアウトになる。左 6 件・右 4 件で件数差のあるケースを確認する。",
      cards: [
        {
          title: "案 A",
          body: [
...

    {
      kind: "cards",
      section: "compare",
      title: "kind: cards ─ 2 枚配置: ポジ／ネガで色分け",
      message:
...

    {
      kind: "cards",
      section: "compare",
      title: "kind: cards ─ 3 枚配置: 並列観点（既定: 全カード gray）",
      message:
        "cards を 3 件にすると並列観点の横並びレイアウトになる。variant 未指定で全カードが gray になる。",
      cards: [
        {
          title: "観点 1: 速度",
...

    {
      kind: "cards",
      section: "compare",
      title: "kind: cards ─ 3 枚配置: 最右に強調を入れるパターン",
      message:
...

    {
      kind: "panel-cards",
      section: "compare",
      title: "kind: panel-cards ─ cards 3 枚と同一内容の比較",
      message:
        "上の cards 3 枚スライドと同じ並列観点（速度 / 品質 / コスト）を panel-cards で描いた版。タイトル帯と区切り線で「項目を読む」前提のレイアウトに切り替わる。",
      cards: [
        {
          title: "観点 1: 速度",
...

    {
      kind: "panel-bullets",
      section: "compare",
      title: "kind: panel-bullets ─ cards 3 枚と同一内容（3 枚）",
      message:
        "panel-cards と同じ枠組み（タイトル帯・区切り線・カード配置）で、items を菱形マーカー付き箇条書きに差し替えたバージョン。cards 3 枚の「速度 / 品質 / コスト」を流用。",
      cards: [
        {
          title: "観点 1: 速度",
          items: ["立ち上げが早い", "市場投入が早い", "PoC で検証しやすい"],
...

    {
      kind: "panel-bullets",
      section: "compare",
      title: "kind: panel-bullets ─ cards 2 枚と同一内容（2 枚, pos/neg）",
      message:
        "cards 2 枚の「良い側面 / 懸念点」を panel-bullets で描いた版。タイトル帯と本文枠線の色は variant で切り替わる。",
      cards: [
        {
          title: "良い側面",
          variant: "pos",
...

    {
      kind: "cards",
      section: "boundary",
      title: "cards 2 枚 ─ 上限ぴったり（6 件 × 全角 26 字）",
      message:
        "1 カードに 6 件、各 bullet を 26 全角字ぴったりに揃えた最大ケース。1 行で収まるかとカード高がフッターに干渉しないかを確認する。",
      cards: [
        {
          title: "左 6 件 × 26 字",
          body: [
            "境界確認の上限文字数までを表示するための長い箇条書き",
            "境界確認の上限文字数までを表示するための長い箇条書き",
            "境界確認の上限文字数までを表示するための長い箇条書き",
            "境界確認の上限文字数までを表示するための長い箇条書き",
            "境界確認の上限文字数までを表示するための長い箇条書き",
...

    {
      kind: "cards",
      section: "boundary",
      title: "cards 2 枚 ─ 上限超過（7 件）",
      message:
        "上限 6 を超えた 7 件。固定 Y を維持できず中央寄せ（slack/2）へフォールバックし、フッターに干渉する挙動を目視確認する。",
      cards: [
        {
          title: "左 7 件",
          body: [
...

    {
      kind: "cards",
      section: "boundary",
      title: "cards 3 枚 ─ 上限ぴったり（各カード 6 件 × 全角 15 字）",
      message:
        "1 カードに 6 件、各 bullet を 15 全角字ぴったりに揃えた最大ケース。3 枚配置のカード幅で折り返さずに 1 行で収まるかを確認する。",
      cards: [
        {
          title: "カード 1",
          body: [
...

    {
      kind: "cards",
      section: "boundary",
      title: "cards 3 枚 ─ 上限超過（各カード 7 件）",
      message:
        "上限 6 を超えた 7 件。固定 Y を維持できず中央寄せへフォールバックし、フッターに干渉する挙動を目視確認する。",
      cards: [
        {
          title: "カード 1",
          body: [
