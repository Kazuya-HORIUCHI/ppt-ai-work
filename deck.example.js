...
module.exports = {
  ...
  slides: [
...

    {
      kind: "cards",
      section: "boundary",
      title: "cards 2 枚 ─ 上限ぴったり（8 件 × 全角 29 字）",
      message:
...

    {
      kind: "cards",
      section: "boundary",
      title: "cards 3 枚 ─ 上限ぴったり（各カード 8 件 × 全角 17 字）",
      message:
        "1 カードに 8 件、各 bullet を 17 全角字ぴったりに揃えた最大ケース。3 枚配置のカード幅で折り返さずに 1 行で収まるかを確認する。",
      cards: [
        {
          title: "カード 1",
          body: [
